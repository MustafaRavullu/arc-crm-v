...
const StockFiberSubtractModal = forwardRef(function StockFiberSubtractModal(
  { label, compare, data },
  ref
) {
      ...
      <div className="flex h-full flex-col gap-3 p-3">
        ...
        <div className="flex justify-between mt-6">
          ...
          <button
            ...
            type="button"
          >
            {loading ? <HashLoader size={20} color="#008000" /> : "Çıkart"}
          </button>
        </div>
      </div>
    </dialog>
...
export default StockFiberSubtractModal;
