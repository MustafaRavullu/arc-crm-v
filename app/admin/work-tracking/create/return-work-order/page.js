    ...
    >
      <div className="absolute inset-0 overflow-auto p-6 flex  flex-col gap-2">
        ...
        <button
          ...
          className="simple_button z-50 w-full flex justify-center md:w-fit"
        >
          {loading ? (
...
const JustSelect = ({ data, setFormData, formData, property, label }) => {
  ...
  return (
    <div className="relative flex flex-col gap-1" ref={ref}>
      ...
      <div
        className={`z-[52] absolute flex flex-col top-full right-0 left-0 rounded-lg bg-arc_black text-white dark:text-black shadow-md dark:bg-white ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <div className="flex border-b items-center border-white dark:border-black">
